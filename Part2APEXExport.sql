...
,p_default_workspace_id=>13001846648807109437
,p_default_application_id=>25012
,p_default_owner=>'DATA_MGT'
);
end;
/
prompt --application/set_environment
 
prompt APPLICATION 25012 - Data Management Part II Fall 2015
--
-- Application Export:
--   Application:     25012
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,25012)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'DATA_MGT')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Data Management Part II Fall 2015')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_25012')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'674F58D656379B50EBEF04D935258693207E3C2E217BF54FEC4C33C6E35187A5'
...
,p_authentication_id=>wwv_flow_api.id(17587726000725345895)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Data Management Part II Fall 2015'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(17587717293290345865)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17587716990075345864)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17587717043716345864)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17587717133226345864)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17587725903269345895)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(17587726164175345898)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17587717375451345865)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17587717458808345868)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17587717555250345869)
,p_page_template_id=>wwv_flow_api.id(17587717458808345868)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17587717611263345869)
,p_page_template_id=>wwv_flow_api.id(17587717458808345868)
,p_name=>'Header Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17587717737490345869)
,p_page_template_id=>wwv_flow_api.id(17587717458808345868)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17587718263994345872)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17587720631359345881)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17587724864738345885)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718352074345873)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718416761345874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718594812345874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718682479345874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718730454345874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718845219345874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587718955129345875)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719054684345875)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719170681345875)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719240268345875)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719342165345875)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719439365345876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719569613345876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17587719681673345876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17587719847764345877)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17587719983769345878)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17587720065532345879)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17587720180577345879)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17587720268767345879)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17587719704025345876)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17587720348392345879)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17587720434092345880)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17587720522579345880)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(17587725245817345886)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(17587725135555345886)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(17587725734897345890)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(17587717458808345868)
,p_default_dialog_template=>wwv_flow_api.id(17587717375451345865)
,p_error_template=>wwv_flow_api.id(17587717458808345868)
,p_printer_friendly_template=>wwv_flow_api.id(17587717458808345868)
,p_login_template=>wwv_flow_api.id(17587717458808345868)
,p_default_button_template=>wwv_flow_api.id(17587724864738345885)
,p_default_region_template=>wwv_flow_api.id(17587719439365345876)
,p_default_chart_template=>wwv_flow_api.id(17587719439365345876)
,p_default_form_template=>wwv_flow_api.id(17587719439365345876)
,p_default_reportr_template=>wwv_flow_api.id(17587719681673345876)
,p_default_tabform_template=>wwv_flow_api.id(17587719439365345876)
,p_default_wizard_template=>wwv_flow_api.id(17587719439365345876)
,p_default_irr_template=>wwv_flow_api.id(17587719439365345876)
,p_default_report_template=>wwv_flow_api.id(17587719704025345876)
,p_default_label_template=>wwv_flow_api.id(17587720434092345880)
,p_default_calendar_template=>wwv_flow_api.id(17587725135555345886)
,p_default_list_template=>wwv_flow_api.id(17587720065532345879)
,p_default_nav_list_template=>wwv_flow_api.id(17587719983769345878)
,p_default_top_nav_list_temp=>wwv_flow_api.id(17587719983769345878)
,p_default_side_nav_list_temp=>wwv_flow_api.id(17587720268767345879)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(17587718352074345873)
,p_default_dialogr_template=>wwv_flow_api.id(17587719439365345876)
,p_default_option_label=>wwv_flow_api.id(17587720434092345880)
,p_default_header_template=>wwv_flow_api.id(17587719170681345875)
,p_default_footer_template=>wwv_flow_api.id(17587718955129345875)
,p_default_required_label=>wwv_flow_api.id(17587720522579345880)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17587725379728345887)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17587725413404345887)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17587725537805345887)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17587725681448345887)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(17587717896553345871)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(17587720751344345882)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(17587721266277345882)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587717919532345871)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(17587717896553345871)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587718079043345872)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587718162475345872)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587720866938345882)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(17587720631359345881)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(17587720751344345882)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587720984506345882)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721006072345882)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721121624345882)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721315967345882)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(17587721266277345882)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721414078345882)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721547703345882)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721684393345882)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721761735345882)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721810007345883)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587721929391345883)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722042159345883)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722194704345883)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722280035345883)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722314821345883)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722441646345883)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722596978345883)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722645383345883)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722789387345883)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722883038345883)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587722931633345884)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723016149345884)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723125902345884)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723247199345884)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723312521345884)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723432267345884)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723592848345884)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723664244345884)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723755362345884)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723813650345884)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587723999377345884)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724028721345884)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724179620345884)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724215186345884)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724375674345885)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724496680345885)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724597891345885)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724678789345885)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724777841345885)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587724963870345885)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17587725022195345885)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17587726000725345895)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(17587725813735345894)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(17587717293290345865)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(17587720268767345879)
...
,p_last_upd_yyyymmddhh24miss=>'20151118081425'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17587726472914345900)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17587719170681345875)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17587726701387345902)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17587718955129345875)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17587726687030345902)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(17587726472914345900)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17587726508224345901)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(17587726892268345902)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(17587726508224345901)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(17587726892268345902)
,p_event_id=>wwv_flow_api.id(17587726892268345902)
,p_event_result=>'TRUE'
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_page_template_options=>'#DEFAULT#'
,p_page_transition=>'SLIDEFADE'
,p_popup_transition=>'SLIDEFADE'
,p_overwrite_navigation_list=>'N'
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18002505053024741662)
,p_plug_name=>'Result'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18002487234179741645)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18002486829628741641)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(17587724864738345885)
,p_button_image_alt=>'Team List'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18053679291931000205)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(18002486829628741641)
,p_button_name=>'Player'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(17587724864738345885)
,p_button_image_alt=>'Player List'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18002487686724741647)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18002498402648741652)
,p_name=>'P2_DB'
,p_item_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18002504006821741660)
,p_name=>'P2_QUERY'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18002486829628741641)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18053679021911000203)
,p_name=>'Modify P2_QUERY for Team'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18053678948543000202)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18053679173458000204)
,p_event_id=>wwv_flow_api.id(18053679021911000203)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_attribute_02=>'"SELECT t.name FROM team t"'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18068700479834023025)
,p_event_id=>wwv_flow_api.id(18053679021911000203)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18054877286410260435)
,p_name=>'P2_QUERY for picking Team'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_TEAM_LIST'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18054877354143260436)
,p_event_id=>wwv_flow_api.id(18054877286410260435)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
,p_attribute_06=>'RETURN ''"SELECT p.name FROM player p WHERE p.t_id = '' || :P2_TEAM_LIST || ''"'';'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18053679324154000206)
,p_name=>'Modify P2_QUERY for Player'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18053679291931000205)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18053679475920000207)
,p_event_id=>wwv_flow_api.id(18053679324154000206)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
,p_affected_elements=>'P2_QUERY'
,p_attribute_01=>'STATIC_ASSIGNMENT'
,p_attribute_02=>'"SELECT p.name FROM player p"'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18068700673349023027)
,p_event_id=>wwv_flow_api.id(18053679324154000206)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_name=>'NBA Teams'
,p_page_mode=>'NORMAL'
,p_step_title=>'NBA Teams'
,p_step_sub_title=>'NBA Teams'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_page_template_options=>'#DEFAULT#'
,p_page_transition=>'SLIDEFADE'
,p_popup_transition=>'SLIDEFADE'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ALVIN.Q.DENG@UTEXAS.EDU'
,p_last_upd_yyyymmddhh24miss=>'20151122001331'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18007644426764311458)
,p_plug_name=>'NBA Teams'
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18054877648084260439)
,p_name=>'TEAM'
,p_data_type=>'TEAM'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18054877752358260440)
,p_name=>'CONFERENCE'
,p_data_type=>'CONFERENCE'
,p_is_visible=>true
,p_display_sequence=>20
,p_heading=>'Conference'
,p_heading_alignment=>'CENTER'
,p_value_alignment=>'LEFT'
,p_attribute_01=>'PLAIN'
,p_escape_on_http_output=>true
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18008695370240683896)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'NBA Team Polling'
,p_attribute_01=>wwv_flow_api.id(17587753093235351163)
,p_attribute_02=>'COLLECTION'
...
,p_name=>'NBA Players'
,p_page_mode=>'NORMAL'
,p_step_title=>'NBA Players'
,p_step_sub_title=>'NBA Players'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ALVIN.Q.DENG@UTEXAS.EDU'
,p_last_upd_yyyymmddhh24miss=>'20151122031328'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18010100778697974256)
,p_plug_name=>'NBA Players'
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18068701929896023040)
,p_name=>'Player Name'
,p_data_type=>'Player Name'
,p_is_visible=>true
,p_display_sequence=>10
,p_heading=>'Player name'
,p_heading_alignment=>'CENTER'
,p_value_alignment=>'LEFT'
,p_attribute_01=>'PLAIN'
,p_attribute_25=>'1'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18068702060804023041)
,p_name=>'Team Name'
,p_data_type=>'Team Name'
,p_is_visible=>true
,p_display_sequence=>20
,p_heading=>'Team name'
,p_heading_alignment=>'CENTER'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18068702133636023042)
,p_name=>'Player Position'
,p_data_type=>'Player Position'
,p_is_visible=>true
,p_display_sequence=>30
,p_heading=>'Player position'
,p_heading_alignment=>'CENTER'
,p_value_alignment=>'LEFT'
,p_attribute_01=>'PLAIN'
,p_attribute_25=>'1'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18068702247880023043)
,p_name=>'Player Height (cm)'
,p_data_type=>'Player Height (cm)'
,p_is_visible=>true
,p_display_sequence=>40
,p_heading=>'Player height (cm)'
,p_heading_alignment=>'CENTER'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18010224522398992473)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'NBA Player Polling'
,p_process_sql_clob=>'17587752876055351160:17587753093235351163'
,p_attribute_01=>wwv_flow_api.id(17587753093235351163)
,p_attribute_02=>'COLLECTION'
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(17587752876055351160)
,p_name=>'NbaREST'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(17587753093235351163)
,p_ws_id=>wwv_flow_api.id(17587752876055351160)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17587753363618351170)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002504499475741661)
,p_parameter_id=>wwv_flow_api.id(17587753363618351170)
,p_process_id=>wwv_flow_api.id(18002498018003741649)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_QUERY'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008748442080683902)
,p_parameter_id=>wwv_flow_api.id(17587753363618351170)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
,p_parm_value=>'"SELECT t.name AS team_name , c.name AS conference_name FROM team t JOIN conference c WHERE t.c_id = c.c_id"'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18010227622065992480)
,p_parameter_id=>wwv_flow_api.id(17587753363618351170)
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17587784583348357043)
,p_ws_opers_id=>wwv_flow_api.id(17587753093235351163)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002498837302741654)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008695639637683899)
,p_parameter_id=>wwv_flow_api.id(17587784583348357043)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18010224881069992477)
,p_parameter_id=>wwv_flow_api.id(17587784583348357043)
,p_process_id=>wwv_flow_api.id(18010224522398992473)
,p_map_type=>'STATIC'
,p_parm_value=>'jdbc:oracle:thin:@sayonara.microlab.cs.utexas.edu:1521:orcl'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002499682055741655)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008696034127683900)
,p_parameter_id=>wwv_flow_api.id(17587784892824357043)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17587785196437357043)
,p_ws_opers_id=>wwv_flow_api.id(17587753093235351163)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002500456206741656)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008696487591683900)
,p_parameter_id=>wwv_flow_api.id(17587785196437357043)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18010225610827992478)
,p_parameter_id=>wwv_flow_api.id(17587785196437357043)
,p_process_id=>wwv_flow_api.id(18010224522398992473)
,p_map_type=>'STATIC'
,p_parm_value=>'orcl_qd472'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002501221886741657)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008696822705683901)
,p_parameter_id=>wwv_flow_api.id(17587785491723357044)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17587785724196357044)
,p_ws_opers_id=>wwv_flow_api.id(17587753093235351163)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002502000282741658)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008697252920683901)
,p_parameter_id=>wwv_flow_api.id(17587785724196357044)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
,p_parm_value=>'D2'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18010226417744992479)
,p_parameter_id=>wwv_flow_api.id(17587785724196357044)
,p_process_id=>wwv_flow_api.id(18010224522398992473)
,p_map_type=>'STATIC'
,p_parm_value=>'D2'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002502847627741660)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008697644424683901)
,p_parameter_id=>wwv_flow_api.id(17587786081012357044)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
,p_parm_value=>'False'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18010226890666992479)
,p_parameter_id=>wwv_flow_api.id(17587786081012357044)
,p_process_id=>wwv_flow_api.id(18010224522398992473)
,p_map_type=>'STATIC'
,p_parm_value=>'False'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18002503694635741660)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008748007038683902)
,p_parameter_id=>wwv_flow_api.id(17587786345312357044)
,p_process_id=>wwv_flow_api.id(18008695370240683896)
,p_map_type=>'STATIC'
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(17993531836991608984)
);
end;
/
